...
function Signup() {
  ...
  const [uploadingImg, setUploadingImg]=setState(false);
  const [imagePreview, setImagePreview]=setState(null);
  ...
  return (
    ...
    <Row>
      ...
      <Col md={7} className="d-flex align-items-center flex-direction-column">
      <Form style={{width:'80%', maxWidth:500}} onSubmit={handleSignup}>
        <h1 className="text-center">Create Account</h1>
          <div className="signup-profile-pic_container">
            <img src={ imagePreview || botImg } className="signup-profile-pic" alt='img'/>
